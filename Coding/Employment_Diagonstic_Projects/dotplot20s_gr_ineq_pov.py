...
data = {
    'Bangladesh': {'GDP Growth\nRate': 5.497, 'Poverty Headcount\nRatio': 5.9,   'Gini Index\nScore': 30.9,   'Unemployment\nRate': 4.392},
    'Cambodia':   {'GDP Growth\nRate': 3.129, 'Poverty Headcount\nRatio': None,  'Gini Index\nScore': None,    'Unemployment\nRate': 0.264},
    'China':      {'GDP Growth\nRate': 4.887, 'Poverty Headcount\nRatio': 0.0,   'Gini Index\nScore': 36.267, 'Unemployment\nRate': 4.734},
    'India':      {'GDP Growth\nRate': 5.441, 'Poverty Headcount\nRatio': 5.3,   'Gini Index\nScore': 25.5,   'Unemployment\nRate': 5.271},
    'Indonesia':  {'GDP Growth\nRate': 3.405, 'Poverty Headcount\nRatio': 7.68,  'Gini Index\nScore': 35.46,  'Unemployment\nRate': 3.565},
    'Thailand':   {'GDP Growth\nRate': 0.528, 'Poverty Headcount\nRatio': 0.025, 'Gini Index\nScore': 34.425, 'Unemployment\nRate': 0.925},
    'Viet Nam':   {'GDP Growth\nRate': 5.223, 'Poverty Headcount\nRatio': 1.45,  'Gini Index\nScore': 36.45,  'Unemployment\nRate': 1.804},
}
...
ax.set_title('Comparison of Country-wise Growth, Poverty and Inequality, 2020s\nPositioned by Relative Performance across Indices',
             fontsize=12, fontfamily=FONT, fontweight='bold', pad=12)
...
plt.savefig(r'D:\Ayon Important\Python\pythonProject\dotplot20s_v2.png',
